...
class Transaksi(db.Model):
    ...
    id_barang = db.Column(db.Integer,db.ForeignKey(Barang.id_barang, onedelete="CASCADE"))
    id_pembeli = db.Column(db.Integer,db.ForeignKey(Pembeli.id_pembeli, onedelete="CASCADE"))
